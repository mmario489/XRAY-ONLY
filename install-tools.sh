...
# ==================================================
# Link Hosting Kalian
mwvpn="raw.githubusercontent.com/MyMasWayVPN/v2/main/ssh"
...
curl https://${mwvpn}/nginx.conf > /etc/nginx/nginx.conf
curl https://${mwvpn}/vps.conf > /etc/nginx/conf.d/vps.conf
sed -i 's/listen = \/var\/run\/php-fpm.sock/listen = 127.0.0.1:9000/g' /etc/php/fpm/pool.d/www.conf
useradd -m vps;
mkdir -p /home/vps/public_html
mkdir -p /home/vps/public_html/ss
mkdir -p /home/vps/public_html/trojan
mkdir -p /home/vps/public_html/vless
mkdir -p /home/vps/public_html/vmess
echo "<?php phpinfo() ?>" > /home/vps/public_html/info.php
chown -R www-data:www-data /home/vps/public_html
chmod -R g+rw /home/vps/public_html
cd /home/vps/public_html
wget -O /home/vps/public_html/index.html "https://${mwvpn}/multiport"
wget -O /home/vps/public_html/ss/index.html "https://${mwvpn}/multiport"
wget -O /home/vps/public_html/vmess/index.html "https://${mwvpn}/multiport"
wget -O /home/vps/public_html/vless/index.html "https://${mwvpn}/multiport"
wget -O /home/vps/public_html/trojan/index.html "https://${mwvpn}/multiport"
